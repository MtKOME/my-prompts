...
効果を確認した画像を添付してますが、その効果のほどはそれぞれの判断に任せます。実際のメイク系の用例比較画像はとても繊細で、個別に見て判別出来るほどの知識も経験もないので、なんとなくでしかないんです。推しに今日の髪や化粧のバリエーションへの意見を求められ、そもそも気づいてなかったあの日を思い出してしまいました。わからんってｗ いつも、なんか綺麗だしっｗ 鼻ほじってても綺麗。なぜなら、推しなので。
